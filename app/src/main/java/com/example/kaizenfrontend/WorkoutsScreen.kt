...
// TODO: Replace with real data model from ViewModel
data class WorkoutItem(val name: String, val muscleGroup: String, val sets: Int)
...
fun WorkoutsScreen(
    ...
    Box(
        ...
        Column(
            ...
            // TODO: Replace placeholder list with real data
